 ...
 *
 * A lookup rather than a switch: adding a logo is adding an entry, and a missing
 * one is a type error rather than a component that silently renders nothing.
 */
const MARKS: Record<TechName, (size: number) => ReactNode> = {
  [TechName.NextJs]: (size) => (
...
export const TechLogo = ({ name, size = 20 }: TechLogoProps) => MARKS[name](size);
